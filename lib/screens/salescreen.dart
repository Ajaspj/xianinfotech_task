...
import 'package:xianinfotech_task/screens/additemscreen.dart';
...
class SaleScreen extends StatelessWidget {
  ...
  SaleScreen({super.key})
      : _invoiceNumber = "${DateTime.now().millisecondsSinceEpoch}",
        _date = DateFormat('dd MMM yy').format(DateTime.now());

  @override
  Widget build(BuildContext context) {
    final saleProvider = Provider.of<SaleController>(context);
